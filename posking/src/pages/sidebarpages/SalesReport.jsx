...
{ label: 'XSL', value: 'xsl' },
   ...
   {/* ...........Report section........ */}
     ...
     <div className="grid grid-cols-4 gap-6 mt-8 pb-8 border-b-1 border-table">
        <InfoOverview title="Total Orders" amount='2' className=" bg-white text-secondry border-1"/>
        <InfoOverview title="Total Earnings" amount='$490.00' className="bg-white text-secondry border-1"/>
        <InfoOverview title="Total Discount" amount='$8.0' className="bg-white text-secondry border-1"/>
         <InfoOverview title="Total Chinpping charge" amount='$10' className="bg-white text-secondry border-1"/>
        </div>
