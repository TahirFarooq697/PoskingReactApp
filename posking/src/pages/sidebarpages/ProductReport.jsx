    ...
    <form className='mt-4'>
     ...
     <div>
       ...
       {/* ...........Report section........ */}
         ...
         <div className="grid grid-cols-3 gap-6 mt-8 pb-8 border-b-1 border-table">
            <InfoOverview title="Total Peoducts" amount='200' className=" bg-white text-secondry border-1"/>
            <InfoOverview title="Total Categories" amount='90.00' className="bg-white text-secondry border-1"/>
            <InfoOverview title="Sold Quantity" amount='1298.0' className="bg-white text-secondry border-1"/>
