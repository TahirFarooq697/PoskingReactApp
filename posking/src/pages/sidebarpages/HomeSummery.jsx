...
import { StateSummery } from './StateSummery';
import { Products } from '../../Components';
import { InfoOverview } from '../../CommonComponents';
export const HomeSummery = () => {
  return (
    <section>
    ...
    <div className="py-3 px-4 text-left">
            ...
            <div className="px-4 " >
                    ...
                    <h2 className="text-xl font-semibold p-3 font-sans text-gray-900 mb-3 mx-auto">Overview</h2>
                         ...
                         <div className="w-[100%] sm:mx-auto md:max-w-full grid grid-cols-1 md:grid-cols-4 gap-6 mb-4 md:mb-8 ">
