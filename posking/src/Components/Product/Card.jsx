...
<img src={product.img} alt={product.name} className="w-full h-32 md:h-48 object-cover rounded-lg transform group-hover:rotate-3 transition-transform duration-300
